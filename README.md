...
(8) Run single_neuron.py. The code should return 1 plot of the decoded neuron output. Don't worry about understanding this code yet! We will get there around T10.
